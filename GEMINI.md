# Zeltra Finance — Agent Behavioral Rules & Engineering Governance (`GEMINI.md`)

Dokumen ini adalah kontrak panduan operasional, pembatasan arsitektur, dan instruksi permanen bagi AI Assistant (Antigravity / Gemini) saat membaca, menulis, merancang, dan merefaktor kode di dalam repository **Zeltra-Finance**.
