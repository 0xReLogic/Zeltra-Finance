...
Dokumen ini memuat daftar 150 kalkulator finansial yang dikelompokkan ke dalam 10 kategori utama.
...
1. **Kalkulator Simulasi KPR Umum**: Hitung cicilan rumah bulanan standar.
2. **Kalkulator KPR Bank BCA**: Custom suku bunga fixed & floating mengikuti promo terbaru BCA.
3. **Kalkulator KPR Bank Mandiri**: Simulasi cicilan khusus produk Mandiri KPR.
4. **Kalkulator KPR Bank BTN**: Fokus pada cicilan rumah subsidi dan nonsubsidi BTN.
...
36. **Kalkulator PPh 21 Metode TER (Tarif Efektif Rata-rata) Terbaru**: Wajib up-to-date dengan aturan Ditjen Pajak.
